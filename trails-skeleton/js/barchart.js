class Barchart {
    ...
    .attr('height', d => vis.height-vis.yScale(vis.yValue(d))) //how do you find the right number in general!!!
    .attr('fill', d => vis.config.colorScale(vis.xValue(d)))//Don't forget "vis." !
