...
![roster lookup](Trackman_Code/img/Screenshot2025-11-07120018.png)
...
![season or game](Trackman_Code/img/Screenshot2025-11-07120033.png)

If the user clicks season, the program open new window with the following layout.
![season screen](Trackman_Code/img/Screenshot2025-11-07130824.png)
...
![filter_screen](Trackman_Code/img/Screenshot2025-11-07120124.png)
...
![Print Graph](Trackman_Code/img/Screenshot2025-11-07120156.png)
...
![Player Graph](Trackman_Code/img/Screenshot2025-11-07120211.png)
...
![Pitch_hover](Trackman_Code/img/Screenshot2025-11-07120211.png)

If the user puts in filters which don't find any data, a box Selection Error window will appear. 
![selection_error](Trackman_Code/img/Screenshot2025-11-07120131.png)
