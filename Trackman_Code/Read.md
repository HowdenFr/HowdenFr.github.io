...
![roster lookup]("Trackman_Code/img/Screenshot%202025-11-07%20120018.png")
...
![season or game]("Trackman_Code/img/Screenshot%202025-11-07%20120033.png")

If the user clicks season, the program open new window with the following layout.
![season screen]("Trackman_Code/img/Screenshot%202025-11-07%20130824.png")
...
![filter_screen]("Trackman_Code/img/Screenshot%202025-11-07%20120124.png")
...
![Print Graph]("Trackman_Code/img/Screenshot%202025-11-07%20120156.png")
...
![Player Graph]("Trackman_Code/img/Screenshot%202025-11-07%20120211.png")
...
![Pitch_hover]("Trackman_Code/img/Screenshot%202025-11-07%20120211.png")

If the user puts in filters which don't find any data, a box Selection Error window will appear. 
![selection_error]("Trackman_Code/img/Screenshot%202025-11-07%20120131.png")
